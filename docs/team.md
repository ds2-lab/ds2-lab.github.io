...
<table width="600px">
	...
	<tr>
		<td width="600px">
			&nbsp;&nbsp; <img style="vertical-align:middle" src="../images/YueCheng_headshot_resized.png" width="100px">
			<ul>
	  ...
	  <div class="card-content">
       	<h3>Junho Lee</h3>
       	  <ul>
  			...
  			<li><b>Project:</b> LLM compression</li>
		  </ul>
	  </div>
  </div>
    ...
    <div class="logo">
	  ...
	  <div class="card-content">
       	<h3>Ben Carver</h3>
			...
			<li><b>First employment:</b> Research Scientist, AI Networking Infrastructure team @ Meta</li>
		  </ul>
	  </div>
  </div>
    ...
    <div class="logo">
	  ...
	  <div class="card-content">
       	<h3>Rui Yang</h3>
			...
			<li><b>First employment:</b> Software engineer, ByteDance Cloud Native Infrastructure (Seattle, WA)</li>
		  </ul>
	  </div>
  </div>
</div>
