...
<table width="600px">
	...
	<tr>
		<td width="600px">
			...
			<ul>
				<li><b>Bio:</b> Yue Cheng is an Assistant Professor of Data Science and Computer Science at the University of Virginia. </li>
  			<ul>
		</td>
	</tr>
</table>
	  ...
	  <div class="card-content">
       	<h3>Yuqi Fu</h3>
       	  <ul>
  			...
  			<li><span class="iconify" data-align="bottom" data-width="11" data-height="11" data-icon="el:home-alt" data-inline="false"></span> <a target="_blank" href="https://mason.gmu.edu/~yfu5/">mason.gmu.edu/~yfu5/</a></li>
		  </ul>
	  </div>
  </div>
    ...
    <div class="logo">
	  ...
	  <div class="card-content">
       	<h3>Zhaoyuan (Alex) Su</h3>
       	  <ul>
  			<li><b>1st Year Ph.D. Student in Computer Science</b></li>
  			<li><b>Research Interests:</b> Federated learning; high-performance computing</li>
		  </ul>
	  </div>
  </div>
