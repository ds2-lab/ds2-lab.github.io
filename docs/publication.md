...
???+ tip "A Closer Look into IPFS: Accessibility, Content, and Performance"
    ...
    === "Paper Info"
	    ...
	    * [:material-file-pdf-box: pdf](https://dl.acm.org/doi/10.1145/3656015){:target="\_blank"} | :material-map-marker: *ACM SIGMETRICS / IFIP Performance ([SIGMETRICS'24](https://www.sigmetrics.org/sigmetrics2024/index.html){:target="\_blank"}), 2024*
